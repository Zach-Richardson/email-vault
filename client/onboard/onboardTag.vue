    ...
    <div class="ui main text container" style="margin-top: 80px;">
        <div class="ui container center aligned">
            <div v-if="monitor" class="ui basic segment huge">
                ...
                as a <b>new</b> Initech user configured to be a "monitor" <br />
